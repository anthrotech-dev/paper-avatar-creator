            ...
            >
                ...
                >
                    <canvas
                        ...
                        width={props.width}
                        height={props.height}
                        style={{ touchAction: 'none', position: 'absolute', top: 0, left: 0, visibility: hiddenLayers[2] ? 'hidden' : 'visible' }}
                    ...
                    <canvas
                        ...
                        width={props.width}
                        height={props.height}
                        style={{ touchAction: 'none', position: 'absolute', top: 0, left: 0, visibility: hiddenLayers[1] ? 'hidden' : 'visible' }}
                        onPointerDown={onPointerDown}
                        onPointerMove={handlePointerMove}
                        onPointerUp={onPointerUp}
                    />
                    <canvas
                        ...
                        width={props.width}
                        height={props.height}
                        style={{ touchAction: 'none', position: 'absolute', top: 0, left: 0, visibility: hiddenLayers[0] ? 'hidden' : 'visible' }}
                        onPointerDown={onPointerDown}
                        onPointerMove={handlePointerMove}
                        onPointerUp={onPointerUp}
                    />
